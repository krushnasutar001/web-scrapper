# Scraze LinkedIn Automation Launcher
# PowerShell script to start both backend and frontend services

# Display banner
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "           SCRAZE LAUNCHER             " -ForegroundColor Yellow
Write-Host "       Scrap with Craze               " -ForegroundColor Yellow
...
Write-Host ""
Write-Host "Starting Scraze Services..." -ForegroundColor Green
Write-Host ""
...
# Success!
Write-Host ""
Write-Host "Scraze is now running!" -ForegroundColor Green
Write-Host ""
...
try {
    ...
    Write-Host "Scraze services stopped. Goodbye!" -ForegroundColor Cyan
}